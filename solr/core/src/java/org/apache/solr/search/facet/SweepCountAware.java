...
interface SweepCountAware {
   ...
   * @see SegCountPerSeg
   */
  class SegCountGlobal implements SegCounter {
  ...
  final class SegCountGlobalCache extends SegCountGlobal {
   ...
   * @see SegCountGlobal
   */
  class SegCountPerSeg implements SegCounter {
  ...
  final class SegCountPerSegCache extends SegCountPerSeg {
    private final CacheUpdater[] cacheUpdaters;
