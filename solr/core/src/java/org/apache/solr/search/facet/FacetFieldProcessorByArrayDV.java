...
class FacetFieldProcessorByArrayDV extends FacetFieldProcessorByArray {
  ...
  protected void collectDocs() throws IOException {
    ...
    final SweepCountAccStruct base = SlotAcc.SweepCoordinator.baseStructOf(this, maySkipBaseSetCollection);
    final List<SweepCountAccStruct> others = SlotAcc.SweepCoordinator.otherStructsOf(this);
